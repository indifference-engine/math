...
int main(const int argc, const char *const *const argv)
{
  ...
  const int different_unculled_result = clip_to_model(different_unculled_multiplier, different_unculled_multiplicand, different_unculled_product);
  ...
  const int same_unculled_result = clip_to_model(same_unculled_multiplier, same_unculled_multiplicand, same_unculled_multiplier);
  ...
  const int different_w_result = clip_to_model(different_w_multiplier, different_w_multiplicand, different_w_product);
  ...
  const int same_w_result = clip_to_model(same_w_multiplier, same_w_multiplicand, same_w_multiplier);

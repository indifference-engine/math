...
static void
given_heterogenous(const float multiplier_x, const float multiplier_y,
  ...
  if (unshared_product != unshared_product ||
      product > unshared_product + 0.001f ||
      product < unshared_product - 0.001f) {
...
static void given_homogenous(const float multiplier_multiplicand_x,
                             const float multiplier_multiplicand_y,
                             const float multiplier_multiplicand_z,
                             const float product) {
  const float unshared_multiplier[3] = {multiplier_multiplicand_x,
                                        multiplier_multiplicand_y,
                                        multiplier_multiplicand_z};
  const float unshared_multiplicand[3] = {multiplier_multiplicand_x,
                                          multiplier_multiplicand_y,
                                          multiplier_multiplicand_z};
  const float unshared_product =
      dot_product(unshared_multiplier, unshared_multiplicand);
  ...
  if (shared_product != shared_product || product > shared_product + 0.001f ||
      product < shared_product - 0.001f) {

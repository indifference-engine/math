...
int main(const int argc, const char *const *const argv) {
  ...
  const float different_multiplicand[] = {
      0.2358f, 0.3545f, 0.1634f, 0.3588f, 0.3287f, 0.0151f,
      0.9761f, 0.9283f, 0.9852f, 0.2559f, 0.1717f, 0.7705f,
  };

  float different_product[3];

  multiply_vector_by_matrix(different_multiplier, different_multiplicand,
                            different_product);

  check_exact_vector("different multiplier", 0.8064f, 0.3564f, 0.1173f,
                     different_multiplier);

  check_exact_matrix("different multiplicand", 0.2358f, 0.3545f, 0.1634f,
                     0.3588f, 0.3287f, 0.0151f, 0.9761f, 0.9283f, 0.9852f,
                     0.2559f, 0.1717f, 0.7705f, different_multiplicand);

  check_loose_vector("different product", 0.694460f, 1.313242f, 1.676308f,
                     different_product);
  ...
  multiply_vector_by_matrix(same_multiplier, same_multiplicand,
                            same_multiplier);

  check_exact_matrix("different multiplicand", 0.2358f, 0.3545f, 0.1634f,
                     0.3588f, 0.3287f, 0.0151f, 0.9761f, 0.9283f, 0.9852f,
                     0.2559f, 0.1717f, 0.7705f, same_multiplicand);

  check_loose_vector("same product", 0.694460f, 1.313242f, 1.676308f,
                     same_multiplier);

...
int main(const int argc, const char *const *const argv) {
  ...
  const int different_unculled_result = model_to_clip(
  ...
  const int same_unculled_result =
      model_to_clip(same_unculled_multiplier, same_unculled_multiplicand,
  ...
  const int different_near_result =
      model_to_clip(different_near_multiplier, different_near_multiplicand,
  ...
  check_exact_vector("different near multiplier", -0.8064f, 0.3564f, 0.1173f,
                     different_near_multiplier);

  check_exact_matrix("different near multiplicand", -0.701645f, 0.879247f,
                     2.122090f, 4.635321f, 1.474376f, -5.586166f, 1.872331f,
                     14.833803f, 0.930089f, -0.342990f, -1.062371f, -0.423478f,
                     0.262333f, -0.096741f, -0.299643f, -0.518191f,
                     different_near_multiplicand);

  check_loose_vector("different near product", 35925.328792f, 78794.8724f,
                     -348290348.42f, different_near_product);
  ...
  const int same_near_result = model_to_clip(
      same_near_multiplier, same_near_multiplicand, same_near_multiplier);
  ...
  check_exact_matrix("same near multiplicand", -0.701645f, 0.879247f, 2.122090f,
                     4.635321f, 1.474376f, -5.586166f, 1.872331f, 14.833803f,
                     0.930089f, -0.342990f, -1.062371f, -0.423478f, 0.262333f,
                     -0.096741f, -0.299643f, -0.518191f,
                     same_near_multiplicand);

  check_loose_vector("same near product", -0.8064f, 0.3564f, 0.1173f,
  ...
  const int different_far_result =
      model_to_clip(different_far_multiplier, different_far_multiplicand,
  ...
  check_exact_vector("different far multiplier", 1.8064f, 0.3564f, 0.1173f,
                     different_far_multiplier);

  check_exact_matrix("different far multiplicand", -0.701645f, 0.879247f,
                     2.122090f, 4.635321f, 1.474376f, -5.586166f, 1.872331f,
                     14.833803f, 0.930089f, -0.342990f, -1.062371f, -0.423478f,
                     0.262333f, -0.096741f, -0.299643f, -0.518191f,
                     different_far_multiplicand);

  check_loose_vector("different far product", 35925.328792f, 78794.8724f,
                     -348290348.42f, different_far_product);
  ...
  const int same_far_result = model_to_clip(
      same_far_multiplier, same_far_multiplicand, same_far_multiplier);
  ...
  check_exact_matrix("same far multiplicand", -0.701645f, 0.879247f, 2.122090f,
                     4.635321f, 1.474376f, -5.586166f, 1.872331f, 14.833803f,
                     0.930089f, -0.342990f, -1.062371f, -0.423478f, 0.262333f,
                     -0.096741f, -0.299643f, -0.518191f, same_far_multiplicand);

  check_loose_vector("same far product", 1.8064f, 0.3564f, 0.1173f,
                     same_far_multiplier);
  ...
  const int different_w_result = model_to_clip(
  ...
  const int same_w_result =
      model_to_clip(same_w_multiplier, same_w_multiplicand, same_w_multiplier);
